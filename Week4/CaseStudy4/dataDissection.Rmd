...
```
The graph confirms that EWR is th worst airport for arrival with an average delay that is almost twice as much as the other 2 airports. The delay of almost double could suggest that EWR has longer fligts.
